...
class PCDHead(GFocalHead):
    ...
    def __init__(self,
                 ...
                 loss_q=dict(type='MSELoss',loss_weight=10),
                 **kwargs):
        super(PCDHead, self).__init__(num_classes, in_channels, **kwargs)
    ...
    def loss_single(self, anchors, cls_score, cls_feat,quality_score, bbox_pred, labels,
                    label_weights, bbox_targets, stride, soft_targets,
                    soft_label,soft_quality_scores, x, teacher_x, vlr_region, num_total_samples):
        ...
        soft_quality_scores = soft_quality_scores.permute(0,2,3,1).reshape(-1,1)
        # ------------------feature imitation based on GI locations----------------

        teacher_score = soft_label.sigmoid() * soft_quality_scores**6

        student_score = cls_feat.detach().sigmoid() * quality_score**6  #[num,80]
        ...
        loss_kd = self.loss_kd(
            ...
            weight=label_weights,
            avg_factor=num_total_samples)
        loss_q = self.loss_q(quality_score,soft_quality_scores)
        return loss_cls, loss_bbox, loss_dfl, loss_ld, loss_ld_vlr, loss_kd, loss_q, loss_kd_neg, loss_im, weight_targets.sum(
        )
    ...
    def loss(self,
        ...
        _, soft_target, soft_label, soft_quality_score = soft_teacher
        ...
        (anchor_list, labels_list, label_weights_list, bbox_targets_list,
         bbox_weights_list, num_total_pos, num_total_neg, assigned_neg_list) = cls_reg_targets
        ...
        losses_cls, losses_bbox, losses_dfl, losses_ld, losses_ld_vlr, losses_kd, losses_q, losses_kd_neg, losses_im,\
    ...
    def get_targets(self,
        ...
        (all_anchors, all_labels, all_label_weights, all_bbox_targets,
         all_bbox_weights, pos_inds_list, neg_inds_list, all_vlr_region) = multi_apply(
        ...
        return (anchors_list, labels_list, label_weights_list,
                ...
                num_total_neg, vlr_regions_list)
